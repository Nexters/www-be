...
import com.promise8.wwwbe.v1.model.dto.res.MeetingCreateResDtoV1;
import com.promise8.wwwbe.v1.model.dto.res.MeetingGetResDtoV1;
import com.promise8.wwwbe.v1.model.dto.res.MeetingMainGetResDtoWrapperV1;
...
public class V1MeetingController {
    ...
    @GetMapping
    public BaseResponse<MeetingMainGetResDtoWrapperV1> getMeetingList(@AuthenticationPrincipal UserPrincipal userPrincipal) {
    ...
    @PostMapping
    public BaseResponse<MeetingCreateResDtoV1> createMeeting(
    ...
    public BaseResponse<MeetingGetResDtoV1> getMeetingById(
            @AuthenticationPrincipal UserPrincipal userPrincipal,
    ...
    public BaseResponse<MeetingGetResDtoV1> getMeetingByCode(
            @AuthenticationPrincipal UserPrincipal userPrincipal,
    ...
    public BaseResponse<Void> joinMeeting(
            @AuthenticationPrincipal UserPrincipal userPrincipal,
            @PathVariable("meetingId") long meetingId,
            @RequestBody JoinMeetingReqDtoV1 joinMeetingReqDto
    ) {
    ...
    public BaseResponse<Void> createPlaceVote(
            @AuthenticationPrincipal UserPrincipal userPrincipal,
            @PathVariable("meetingId") long meetingId,
            @RequestBody PlaceVoteReqDtoV1 placeVoteReqDto
    ) {
    ...
    public BaseResponse<Void> putMeetingAction(
            @AuthenticationPrincipal UserPrincipal userPrincipal,
            @PathVariable("meetingId") long meetingId,
            @PathVariable("meetingStatus") MeetingStatusV1 meetingStatus
    ) {
    ...
    public BaseResponse<Void> confirmMeeting(
            @AuthenticationPrincipal UserPrincipal userPrincipal,
            @PathVariable("meetingId") long meetingId,
            @RequestBody MeetingConfirmDtoV1 meetingConfirmDto
