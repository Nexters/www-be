...
import com.promise8.wwwbe.v1.service.MeetingUserTimetableService;
...
public class MeetingUserTimetableController {
    ...
    public BaseResponse<List<UserPromiseTimeResDto>> getPromiseTimeList(@PathVariable("meetingId") Long meetingId) {
